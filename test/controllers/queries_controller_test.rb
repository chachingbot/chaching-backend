...
class QueriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create query" do
    assert_difference('Query.count') do
      post queries_url, params: { query: { classification_id: @query.classification_id, raw_input: @query.raw_input, resolved: @query.resolved, user_id: @query.user_id } }
    end
  ...
  test "should update query" do
    patch query_url(@query), params: { query: { classification_id: @query.classification_id, raw_input: @query.raw_input, resolved: @query.resolved, user_id: @query.user_id } }
