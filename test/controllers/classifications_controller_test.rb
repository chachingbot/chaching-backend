...
class ClassificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create classification" do
    assert_difference('Classification.count') do
      post classifications_url, params: { classification: { base_type: @classification.base_type, sub_type: @classification.sub_type } }
    end
  ...
  test "should update classification" do
    patch classification_url(@classification), params: { classification: { base_type: @classification.base_type, sub_type: @classification.sub_type } }
